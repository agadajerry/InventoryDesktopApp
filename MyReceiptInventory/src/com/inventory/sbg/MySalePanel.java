...
private void initUI() {
	...
	northPanel.setBackground(new Color(74,140,73));
	// *******************************************************************************************************
	...
	westPanelHolder.setBackground(new Color(240, 98, 146));
	...
	southPanelInWest.setBackground(new Color(74,140,73));
	//
	...
	southPanelInEast.setBackground(new Color(74,140,73));
	...
	eastPanelCenter.setBackground(new Color(240, 98, 146));
	...
	centerPanelColor.setBackground(new Color(74,140,73));

	
	Image myIcon = Toolkit.getDefaultToolkit().getImage(getClass().getResource
			("/com/inventory/sbg/resource/images/loginSuccessful.png"));
	setIconImage(myIcon);

	ImageIcon image = new ImageIcon(myIcon);
	...
	try {
		...
		while (rs.next()) {
			...
			if (qtty <= 0) {
				...
				JOptionPane.showMessageDialog(null, "The quantity of The items You selected is less than one in the Storage..\n"
						+ "Update the depleted Products.");
			}
		}
	} catch (SQLException exc) {
		exc.printStackTrace();
